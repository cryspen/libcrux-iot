...
@[spec]
def keccakf1600_round0_theta_d (s : libcrux_iot_sha3.state.KeccakState) :
...
@[spec]
def keccakf1600_round1_theta_d (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let c_x4_zeta0 : u32 ←
    (← (libcrux_iot_sha3.state.KeccakState.c s)[(4 : usize)]_?)[(0 : usize)]_?;
  let c_x1_zeta1 : u32 ←
...
@[spec]
def keccakf1600_round2_theta_d (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let c_x4_zeta0 : u32 ←
    (← (libcrux_iot_sha3.state.KeccakState.c s)[(4 : usize)]_?)[(0 : usize)]_?;
  let c_x1_zeta1 : u32 ←
...
@[spec]
def keccakf1600_round3_theta_d (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let c_x4_zeta0 : u32 ←
    (← (libcrux_iot_sha3.state.KeccakState.c s)[(4 : usize)]_?)[(0 : usize)]_?;
  let c_x1_zeta1 : u32 ←
...
def keccakf1600_round0_pi_rho_chi_1 (BASE_ROUND : usize)
  ...
  let ax0 : u32 ← (libcrux_secrets.traits.Classify.classify u32 (0 : u32));
  let ax0 : u32 ←
...
def Impl.set_lane_value
  ...
  let self : KeccakState :=
    ...
    with c := (← (rust_primitives.hax.monomorphized_update_at.update_at_usize
      (KeccakState.c self)
      i
      {(← (KeccakState.c self)[i]_?)
      with _0 := (← (rust_primitives.hax.monomorphized_update_at.update_at_usize
        (libcrux_iot_sha3.lane.Lane2U32._0 (← (KeccakState.c self)[i]_?))
        j
        value))}))};
  (pure self)
...
@[spec]
def keccakf1600_round0_theta_c_x0_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
  ...
  let ax_4 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      ...
      (0 : usize));
  let s : libcrux_iot_sha3.state.KeccakState ←
    (libcrux_iot_sha3.state.Impl.set_lane_value
      s
      (0 : usize)
      (0 : usize)
...
@[spec]
def keccakf1600_round0_theta_c_x0_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x1_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x1_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x2_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x2_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x3_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x3_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x4_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round0_theta_c_x4_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
def keccakf1600_round0_theta (s : libcrux_iot_sha3.state.KeccakState) :
  ...
  let s : libcrux_iot_sha3.state.KeccakState ← (keccakf1600_round0_theta_d s);
  (pure s)

@[spec]
def keccakf1600_round1_theta_c_x0_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x0_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x1_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_1 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x1_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_1 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x2_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_2 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x2_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_2 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x3_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_3 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x3_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_3 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x4_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_4 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round1_theta_c_x4_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_4 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
def keccakf1600_round1_theta (s : libcrux_iot_sha3.state.KeccakState) :
  ...
  let s : libcrux_iot_sha3.state.KeccakState ← (keccakf1600_round1_theta_d s);
  (pure s)

@[spec]
def keccakf1600_round2_theta_c_x0_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x0_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x1_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_3 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x1_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_3 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x2_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_1 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x2_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_1 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x3_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_4 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x3_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_4 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x4_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_2 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round2_theta_c_x4_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_2 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
def keccakf1600_round2_theta (s : libcrux_iot_sha3.state.KeccakState) :
  ...
  let s : libcrux_iot_sha3.state.KeccakState ← (keccakf1600_round2_theta_d s);
  (pure s)

set_option maxRecDepth 1000 in

@[spec]
def keccakf1600_round3_theta_c_x0_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x0_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_0 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x1_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_2 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x1_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_2 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x2_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_4 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x2_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_4 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x3_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_1 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x3_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_1 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x4_z0 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_3 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
@[spec]
def keccakf1600_round3_theta_c_x4_z1 (s : libcrux_iot_sha3.state.KeccakState) :
    RustM libcrux_iot_sha3.state.KeccakState := do
  let ax_3 : u32 ←
    (libcrux_iot_sha3.state.Impl.get_with_zeta
      s
...
def keccakf1600_round3_theta (s : libcrux_iot_sha3.state.KeccakState) :
  ...
  let s : libcrux_iot_sha3.state.KeccakState ← (keccakf1600_round3_theta_d s);
  (pure s)
...
def Impl.squeeze (RATE : usize)
  ...
  let out : (RustSlice u8) ←
    (rust_primitives.hax.monomorphized_update_at.update_at_range_to
      out
      (core_models.ops.range.RangeTo.mk (_end := mid))
      (← (libcrux_iot_sha3.state.Impl.store (RATE)
        (KeccakXofState.inner self)
        (← out[(core_models.ops.range.RangeTo.mk (_end := mid))]_?))));
    ...
    (rust_primitives.hax.folds.fold_range
      ...
      (fun ⟨offset, out, self⟩ _ =>
        ...
        (rust_primitives.hax.Tuple3
          ...
          (KeccakXofState (RATE))))));
  let ⟨out, self⟩ ←
    if (← ((← (last >? (0 : usize))) &&? (← (last <? out_len)))) then do
      let _ ←
        if true then do
          let _ ←
            match (rust_primitives.hax.Tuple2.mk last offset) with
...
def sha224 (data : (RustSlice u8)) : RustM (RustArray u8 28) := do
  ...
  let out : (RustArray u8 28) ←
    (rust_primitives.hax.monomorphized_update_at.update_at_range_full
      out
      core_models.ops.range.RangeFull.mk
      (← (sha224_ema (← out[core_models.ops.range.RangeFull.mk]_?) data)));
  (pure out)
...
def sha384 (data : (RustSlice u8)) : RustM (RustArray u8 48) := do
  ...
  let out : (RustArray u8 48) ←
    (rust_primitives.hax.monomorphized_update_at.update_at_range_full
      out
      core_models.ops.range.RangeFull.mk
      (← (sha384_ema (← out[core_models.ops.range.RangeFull.mk]_?) data)));
  (pure out)
...
def sha512 (data : (RustSlice u8)) : RustM (RustArray u8 64) := do
  ...
  let out : (RustArray u8 64) ←
    (rust_primitives.hax.monomorphized_update_at.update_at_range_full
      out
      core_models.ops.range.RangeFull.mk
      (← (sha512_ema (← out[core_models.ops.range.RangeFull.mk]_?) data)));
  (pure out)
...
def shake128 (BYTES : usize) (data : (RustSlice u8)) :
  ...
  let out : (RustArray u8 BYTES) ←
    (rust_primitives.hax.monomorphized_update_at.update_at_range_full
      out
      core_models.ops.range.RangeFull.mk
      (← (libcrux_iot_sha3.portable.keccakx1 ((168 : usize)) ((31 : u8))
        data
        (← out[core_models.ops.range.RangeFull.mk]_?))));
  (pure out)
...
def shake256 (BYTES : usize) (data : (RustSlice u8)) :
  ...
  let out : (RustArray u8 BYTES) ←
    (rust_primitives.hax.monomorphized_update_at.update_at_range_full
      out
      core_models.ops.range.RangeFull.mk
      (← (libcrux_iot_sha3.portable.keccakx1 ((136 : usize)) ((31 : u8))
        data
        (← out[core_models.ops.range.RangeFull.mk]_?))));
  (pure out)
