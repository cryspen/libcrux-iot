/-
  ...
  Layer-M barrier discipline: this file is above the barrier
  (`Spec.lean` is the barrier itself) and may freely use
  `ZMod`/`Mathlib` for the algebraic injectivity argument.
-/
