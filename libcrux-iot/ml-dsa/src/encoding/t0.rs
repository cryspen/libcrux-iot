...
pub(crate) const OUTPUT_BYTES_PER_SIMD_UNIT: usize = 13;
...
#[inline(always)]
#[hax_lib::requires(serialized.len() == OUTPUT_BYTES_PER_SIMD_UNIT * SIMD_UNITS_IN_RING_ELEMENT && ring_elements.len() == RING_ELEMENT_OF_T0S_SIZE)]
