...
typedef libcrux_iot_sha3_keccak_KeccakXofState_31 libcrux_iot_sha3_incremental_Shake128Xof;
...
libcrux_iot_sha3_keccak_fill_buffer_f0_60(
...
*/
static inline size_t
libcrux_iot_sha3_keccak_absorb_full_f0_60(
  libcrux_iot_sha3_keccak_KeccakXofState_31 *self,
  Eurydice_borrow_slice_u8 inputs
)
{
  size_t input_consumed = libcrux_iot_sha3_keccak_fill_buffer_f0_60(self, inputs);
...
libcrux_iot_sha3_keccak_absorb_f0_60(
  libcrux_iot_sha3_keccak_KeccakXofState_31 *self,
  Eurydice_borrow_slice_u8 inputs
)
{
  size_t input_remainder_len = libcrux_iot_sha3_keccak_absorb_full_f0_60(self, inputs);
...
*/
static KRML_MUSTINLINE void
libcrux_iot_sha3_keccak_absorb_final_f0_37(
  libcrux_iot_sha3_keccak_KeccakXofState_31 *self,
  Eurydice_borrow_slice_u8 inputs
)
{
...
- RATE= 168
*/
static inline Eurydice_arr_c5 libcrux_iot_sha3_keccak_zero_block_f0_60(void)
{
  return
...
- RATE= 168
*/
static inline libcrux_iot_sha3_keccak_KeccakXofState_31 libcrux_iot_sha3_keccak_new_f0_60(void)
{
  libcrux_iot_sha3_state_KeccakState uu____0 = libcrux_iot_sha3_state_new_18();
  return
    (
      KRML_CLITERAL(libcrux_iot_sha3_keccak_KeccakXofState_31){
        .inner = uu____0,
...
This function found in impl {libcrux_iot_sha3::incremental::Xof<168usize> for libcrux_iot_sha3::incremental::Shake128Xof}
*/
static inline libcrux_iot_sha3_keccak_KeccakXofState_31
...
*/
static KRML_MUSTINLINE void
libcrux_iot_sha3_keccak_squeeze_f0_60(
  libcrux_iot_sha3_keccak_KeccakXofState_31 *self,
  Eurydice_mut_borrow_slice_u8 out
)
{
