...
pub(crate) fn compress_1(mut a: UnpackedFieldElementArray) -> UnpackedFieldElementArray {
    hax_lib::fstar!(
    ...
    for i in 0..FIELD_ELEMENTS_IN_VECTOR {
        ...
        a[i] = compress_message_coefficient(a[i] as u16) as i16;
        hax_lib::fstar!(
...
pub(crate) fn compress<const COEFFICIENT_BITS: i32>(mut a: UnpackedFieldElementArray) -> UnpackedFieldElementArray {
    hax_lib::fstar!(
    ...
    for i in 0..FIELD_ELEMENTS_IN_VECTOR {
        ...
        a[i] =
            compress_ciphertext_coefficient(COEFFICIENT_BITS as u8, a[i] as u16) as i16;
        hax_lib::fstar!(
            r#"assert (v (${a}.f_elements.[ $i ] <: i16) >= 0 /\
...
pub(crate) fn decompress_ciphertext_coefficient<const COEFFICIENT_BITS: i32>(
    mut a: UnpackedFieldElementArray,
    ...
    for i in 0..FIELD_ELEMENTS_IN_VECTOR {
        ...
        let mut decompressed = a[i] as i32 * FIELD_MODULUS as i32;
        hax_lib::fstar!(
