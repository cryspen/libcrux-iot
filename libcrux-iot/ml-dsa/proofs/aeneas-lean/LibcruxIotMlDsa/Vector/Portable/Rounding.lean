...
/-!
  # `Vector/Portable/Rounding.lean` — Phase-7 `decompose` dual-output keystone
  ...
  defining inequalities. The math is identical to the validated isolation proof; only
  the term size changed.
