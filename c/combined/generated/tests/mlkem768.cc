...
TEST(MlKem768TestPortable, NISTKnownAnswerTest) {
  ...
  for (auto kat : kats) {
    ...
    auto pk_hash = libcrux_iot_sha3_sha256(mk_borrow_slice_u8(
    ...
    auto sk_hash = libcrux_iot_sha3_sha256(mk_borrow_slice_u8(
        key_pair.sk.data, LIBCRUX_IOT_ML_KEM_MLKEM768_SECRET_KEY_SIZE));
    EXPECT_EQ(0,
    ...
    auto ct_hash = libcrux_iot_sha3_sha256(mk_borrow_slice_u8(
        ctxt.fst.data, LIBCRUX_IOT_ML_KEM_MLKEM768_CPA_PKE_CIPHERTEXT_SIZE));
    EXPECT_EQ(0,
