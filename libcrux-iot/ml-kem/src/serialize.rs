...
#[hax_lib::ensures(|_| fstar!(r#"forall (i:nat). i < 16 ==>
    v (Seq.index (Libcrux_ml_kem.Vector.Traits.f_to_i16_array ${out}_future) i) >= 0 /\
    v (Seq.index (Libcrux_ml_kem.Vector.Traits.f_to_i16_array ${out}_future) i) < v $FIELD_MODULUS"#))]
