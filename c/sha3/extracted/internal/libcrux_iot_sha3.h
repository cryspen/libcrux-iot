...
- RATE= 168
*/
void libcrux_iot_sha3_keccak_absorb_f0_60(
    libcrux_iot_sha3_keccak_KeccakXofState_31 *self,
    Eurydice_borrow_slice_u8 inputs);
...
- DELIMITER= 31
*/
void libcrux_iot_sha3_keccak_absorb_final_f0_37(
    libcrux_iot_sha3_keccak_KeccakXofState_31 *self,
    Eurydice_borrow_slice_u8 inputs);
...
- RATE= 168
*/
void libcrux_iot_sha3_state_store_18_60(libcrux_iot_sha3_state_KeccakState self,
                                        Eurydice_mut_borrow_slice_u8 out);
...
- RATE= 168
*/
void libcrux_iot_sha3_keccak_squeeze_f0_60(
    libcrux_iot_sha3_keccak_KeccakXofState_31 *self,
    Eurydice_mut_borrow_slice_u8 out);
...
libcrux_iot_sha3::lane::Lane2U32}
*/
Eurydice_arr_a0 libcrux_iot_sha3_lane_clone_f6(const Eurydice_arr_a0 *self);
