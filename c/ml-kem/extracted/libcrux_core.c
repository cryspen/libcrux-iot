...
libcrux_iot_ml_kem_types_MlKemPublicKey_64 libcrux_iot_ml_kem_types_from_18_af(
  ...
  libcrux_iot_ml_kem_types_MlKemPublicKey_64 lit;
...
libcrux_iot_ml_kem_types_from_d9_94(
  ...
  return (KRML_CLITERAL(libcrux_iot_ml_kem_mlkem1024_MlKem1024KeyPair){
      .sk = sk, .pk = pk});
}
...
libcrux_iot_ml_kem_types_MlKemPrivateKey_83 libcrux_iot_ml_kem_types_from_56_39(
  ...
  libcrux_iot_ml_kem_types_MlKemPrivateKey_83 lit;
...
libcrux_iot_ml_kem_types_from_9d_af(uint8_t value[1568U]) {
  ...
  uint8_t copy_of_value[1568U];
  memcpy(copy_of_value, value, (size_t)1568U * sizeof(uint8_t));
  libcrux_iot_ml_kem_mlkem1024_MlKem1024Ciphertext lit;
  memcpy(lit.value, copy_of_value, (size_t)1568U * sizeof(uint8_t));
  return lit;
}
...
libcrux_iot_ml_kem_types_MlKemPublicKey_30 libcrux_iot_ml_kem_types_from_18_d0(
  ...
  libcrux_iot_ml_kem_types_MlKemPublicKey_30 lit;
...
libcrux_iot_ml_kem_mlkem768_MlKem768KeyPair libcrux_iot_ml_kem_types_from_d9_74(
  ...
  return (KRML_CLITERAL(libcrux_iot_ml_kem_mlkem768_MlKem768KeyPair){.sk = sk,
                                                                     .pk = pk});
}
...
libcrux_iot_ml_kem_types_MlKemPrivateKey_d9 libcrux_iot_ml_kem_types_from_56_28(
  ...
  libcrux_iot_ml_kem_types_MlKemPrivateKey_d9 lit;
...
libcrux_iot_ml_kem_types_from_9d_80(uint8_t value[1088U]) {
  ...
  libcrux_iot_ml_kem_mlkem768_MlKem768Ciphertext lit;
