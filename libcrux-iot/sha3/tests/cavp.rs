...
/// [spec-test](http://github.com/cryspen/libcrux-iot/blob/franziskus/proofs-and-reqs/libcrux-iot/sha3/specs/api.md#EQ-01-01)
sha3_test!(SHA3_224LongMsg, SHA3_224_DIGEST_SIZE, Algorithm::Sha224);
/// [spec-test](http://github.com/cryspen/libcrux-iot/blob/franziskus/proofs-and-reqs/libcrux-iot/sha3/specs/api.md#EQ-01-02)
sha3_test!(SHA3_256LongMsg, SHA3_256_DIGEST_SIZE, Algorithm::Sha256);
/// [spec-test](http://github.com/cryspen/libcrux-iot/blob/franziskus/proofs-and-reqs/libcrux-iot/sha3/specs/api.md#EQ-01-03)
sha3_test!(SHA3_384LongMsg, SHA3_384_DIGEST_SIZE, Algorithm::Sha384);
/// [spec-test](http://github.com/cryspen/libcrux-iot/blob/franziskus/proofs-and-reqs/libcrux-iot/sha3/specs/api.md#EQ-01-04)
...
/// [spec-test](http://github.com/cryspen/libcrux-iot/blob/franziskus/proofs-and-reqs/libcrux-iot/sha3/specs/api.md#EQ-02-01)
shake_test!(SHAKE128LongMsg, shake128_ema);
/// [spec-test](http://github.com/cryspen/libcrux-iot/blob/franziskus/proofs-and-reqs/libcrux-iot/sha3/specs/api.md#EQ-02-01)
shake_test!(SHAKE128ShortMsg, shake128_ema);

/// [spec-test](http://github.com/cryspen/libcrux-iot/blob/franziskus/proofs-and-reqs/libcrux-iot/sha3/specs/api.md#EQ-02-02)
