...
#[hax_lib::ensures(|_| fstar!(r#"forall (i:nat). i < 16 ==> v (${a}_future.f_elements.[ sz i ] <: i16) >= 0 /\
...
#[hax_lib::ensures(|_| fstar!(r#"forall (i:nat). i < 16 ==> v (Seq.index ${a}_future.f_elements i) < v $FIELD_MODULUS"#))]
