...
private theorem i32_i64_bound (z : Std.I32) (w : Std.I64) (hw : w.val = z.val) :
  ...
  simp only [IScalar.min_IScalarTy_I32_eq, IScalar.max_IScalarTy_I32_eq, Aeneas.Std.I32.min,
    Aeneas.Std.I32.max, Aeneas.Std.I32.numBits, IScalarTy.I32_numBits_eq] at h
  rw [hw]; omega
...
private theorem i64_mul_canon_diff_ok (a b : Std.I64) (zb1 zb2 : Std.I32)
  ...
  simp only [IScalar.min_IScalarTy_I32_eq, IScalar.max_IScalarTy_I32_eq, Aeneas.Std.I32.min,
    Aeneas.Std.I32.max, Aeneas.Std.I32.numBits, IScalarTy.I32_numBits_eq] at hb1lo hb1hi hb2lo hb2hi
...
/-- **`ntt.ntt` ↔ extracted `hacspec_ml_dsa.ntt.ntt`** (`@[spec]` Triple). Composes the
    impl `ntt_fc` post with `ntt_hacspec_eq`. -/
@[spec]
theorem ntt_hacspec_fc
  ...
  obtain ⟨r, hr_eq, hr_lift, _hr_bnd⟩ :=
    triple_exists_ok (libcrux_iot_ml_dsa.Polynomial.Ntt.ntt_fc re B hB hin)
