...
val serialize_1_
    ...
    : Prims.Pure (t_Slice u8)
      (requires (Core_models.Slice.impl__len #u8 out <: usize) =. mk_usize 2)
      (ensures
        fun out_future ->
...
val deserialize_1_
    ...
    : Prims.Pure Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 v <: usize) =. mk_usize 2)
      (fun _ -> Prims.l_True)

val serialize_4_int (v: t_Slice i16)
    : Prims.Pure (u8 & u8 & u8 & u8)
      (requires (Core_models.Slice.impl__len #i16 v <: usize) =. mk_usize 8)
      (fun _ -> Prims.l_True)
...
val serialize_4_
      ...
      (out: t_Slice u8)
    : Prims.Pure (t_Slice u8)
      (requires (Core_models.Slice.impl__len #u8 out <: usize) =. mk_usize 8)
      (ensures
        fun out_future ->
          let out_future:t_Slice u8 = out_future in
...
val deserialize_4_int (bytes: t_Slice u8)
    : Prims.Pure (i16 & i16 & i16 & i16 & i16 & i16 & i16 & i16)
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 4)
      (fun _ -> Prims.l_True)
...
val deserialize_4_
      ...
      (out: Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector)
    : Prims.Pure Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 8)
      (fun _ -> Prims.l_True)
...
val serialize_5_
      ...
      (out: t_Slice u8)
    : Prims.Pure (t_Slice u8)
      (requires (Core_models.Slice.impl__len #u8 out <: usize) =. mk_usize 10)
      (ensures
        fun out_future ->
          let out_future:t_Slice u8 = out_future in
...
val deserialize_5_int (bytes: t_Slice u8)
    : Prims.Pure (i16 & i16 & i16 & i16 & i16 & i16 & i16 & i16)
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 5)
      (fun _ -> Prims.l_True)
...
val deserialize_5_
      ...
      (out: Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector)
    : Prims.Pure Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 10)
      (fun _ -> Prims.l_True)

val serialize_10_int (v: t_Slice i16)
    : Prims.Pure (u8 & u8 & u8 & u8 & u8)
      (requires (Core_models.Slice.impl__len #i16 v <: usize) =. mk_usize 4)
      (fun _ -> Prims.l_True)
...
val serialize_10_
      ...
      (out: t_Slice u8)
    : Prims.Pure (t_Slice u8)
      (requires (Core_models.Slice.impl__len #u8 out <: usize) =. mk_usize 20)
      (ensures
        fun out_future ->
          let out_future:t_Slice u8 = out_future in
...
val deserialize_10_
      ...
      (out: Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector)
    : Prims.Pure Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 20)
      (fun _ -> Prims.l_True)
...
val serialize_11_
      ...
      (out: t_Slice u8)
    : Prims.Pure (t_Slice u8)
      (requires (Core_models.Slice.impl__len #u8 out <: usize) =. mk_usize 22)
      (ensures
        fun out_future ->
          let out_future:t_Slice u8 = out_future in
...
val deserialize_11_int (bytes: t_Slice u8)
    : Prims.Pure (i16 & i16 & i16 & i16 & i16 & i16 & i16 & i16)
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 11)
      (fun _ -> Prims.l_True)
...
val deserialize_11_
      ...
      (out: Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector)
    : Prims.Pure Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 22)
      (fun _ -> Prims.l_True)

val serialize_12_int (v: t_Slice i16)
    : Prims.Pure (u8 & u8 & u8)
      (requires (Core_models.Slice.impl__len #i16 v <: usize) =. mk_usize 2)
      (fun _ -> Prims.l_True)
...
val serialize_12_
      ...
      (out: t_Slice u8)
    : Prims.Pure (t_Slice u8)
      (requires (Core_models.Slice.impl__len #u8 out <: usize) =. mk_usize 24)
      (ensures
        fun out_future ->
          let out_future:t_Slice u8 = out_future in
...
val deserialize_12_int (bytes: t_Slice u8)
    : Prims.Pure (i16 & i16)
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 3)
      (fun _ -> Prims.l_True)
...
val deserialize_12_
      ...
      (out: Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector)
    : Prims.Pure Libcrux_iot_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 24)
      (fun _ -> Prims.l_True)
