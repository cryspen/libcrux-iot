...
-- Per-round functional equivalence proofs are in extraction/round_equiv.lean
-- (separate file to keep hax_mvcgen's internal simp within its 100K step limit).
...
-- Rounds 0-3 func_equiv: see extraction/round_equiv.lean
