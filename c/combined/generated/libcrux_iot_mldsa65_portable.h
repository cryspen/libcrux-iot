...
#define LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2 ((LIBCRUX_IOT_ML_DSA_CONSTANTS_FIELD_MODULUS - (int32_t)1) / (int32_t)32)
...
)
{
  ...
  state = libcrux_iot_sha3_portable_incremental_shake256_init();
...
{
  libcrux_iot_sha3_state_KeccakState
  state0 = libcrux_iot_sha3_portable_incremental_shake128_init();
  libcrux_iot_sha3_portable_incremental_shake128_absorb_final(&state0, input0);
  libcrux_iot_sha3_state_KeccakState
  state1 = libcrux_iot_sha3_portable_incremental_shake128_init();
  libcrux_iot_sha3_portable_incremental_shake128_absorb_final(&state1, input1);
  libcrux_iot_sha3_state_KeccakState
  state2 = libcrux_iot_sha3_portable_incremental_shake128_init();
  libcrux_iot_sha3_portable_incremental_shake128_absorb_final(&state2, input2);
  libcrux_iot_sha3_state_KeccakState
  state3 = libcrux_iot_sha3_portable_incremental_shake128_init();
...
{
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_first_five_blocks(&state->state0,
    Eurydice_array_to_slice_mut_a8(out0));
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_first_five_blocks(&state->state1,
    Eurydice_array_to_slice_mut_a8(out1));
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_first_five_blocks(&state->state2,
    Eurydice_array_to_slice_mut_a8(out2));
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_first_five_blocks(&state->state3,
...
)
{
  ...
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_next_block(&state->state0,
  ...
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_next_block(&state->state1,
  ...
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_next_block(&state->state2,
  ...
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_next_block(&state->state3,
...
{
  libcrux_iot_sha3_state_KeccakState
  state0 = libcrux_iot_sha3_portable_incremental_shake256_init();
  libcrux_iot_sha3_portable_incremental_shake256_absorb_final(&state0, input0);
  libcrux_iot_sha3_state_KeccakState
  state1 = libcrux_iot_sha3_portable_incremental_shake256_init();
  libcrux_iot_sha3_portable_incremental_shake256_absorb_final(&state1, input1);
  libcrux_iot_sha3_state_KeccakState
  state2 = libcrux_iot_sha3_portable_incremental_shake256_init();
  libcrux_iot_sha3_portable_incremental_shake256_absorb_final(&state2, input2);
  libcrux_iot_sha3_state_KeccakState
  state3 = libcrux_iot_sha3_portable_incremental_shake256_init();
...
)
{
  ...
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_first_block(&state->state0,
  ...
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_first_block(&state->state1,
  ...
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_first_block(&state->state2,
  ...
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_first_block(&state->state3,
...
)
{
  ...
  memcpy(out0.data, repeat_expression0, (size_t)136U * sizeof (uint8_t));
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_next_block(&state->state0,
    Eurydice_array_to_slice_mut_d4(&out0));
  Eurydice_arr_3d out1;
  uint8_t repeat_expression1[136U];
  for (size_t i = (size_t)0U; i < (size_t)136U; i++)
  ...
  memcpy(out1.data, repeat_expression1, (size_t)136U * sizeof (uint8_t));
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_next_block(&state->state1,
    Eurydice_array_to_slice_mut_d4(&out1));
  Eurydice_arr_3d out2;
  uint8_t repeat_expression2[136U];
  for (size_t i = (size_t)0U; i < (size_t)136U; i++)
  ...
  memcpy(out2.data, repeat_expression2, (size_t)136U * sizeof (uint8_t));
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_next_block(&state->state2,
    Eurydice_array_to_slice_mut_d4(&out2));
  Eurydice_arr_3d out3;
  uint8_t repeat_expression[136U];
  for (size_t i = (size_t)0U; i < (size_t)136U; i++)
  ...
  memcpy(out3.data, repeat_expression, (size_t)136U * sizeof (uint8_t));
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_next_block(&state->state3,
    Eurydice_array_to_slice_mut_d4(&out3));
  return
    (KRML_CLITERAL(Eurydice_arr_3d_x4){ .fst = out0, .snd = out1, .thd = out2, .f3 = out3 });
}
...
)
{
  ...
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_first_block(state,
...
)
{
  ...
  memcpy(out.data, repeat_expression, (size_t)136U * sizeof (uint8_t));
  libcrux_iot_sha3_portable_incremental_shake256_squeeze_next_block(state,
    Eurydice_array_to_slice_mut_d4(&out));
  return out;
}
...
{
  libcrux_iot_sha3_state_KeccakState
  state = libcrux_iot_sha3_portable_incremental_shake128_init();
...
{
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_first_five_blocks(self,
    Eurydice_array_to_slice_mut_a8(out));
}
...
{
  libcrux_iot_sha3_portable_incremental_shake128_squeeze_next_block(self,
    Eurydice_array_to_slice_mut_7b(out));
}
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_mut_367(&out,
      (KRML_CLITERAL(core_ops_range_Range_08){ .start = (size_t)0U, .end = slice.meta })),
    slice,
    uint8_t);
  out.data[64U] = libcrux_secrets_int_public_integers_classify_27_90((uint8_t)domain_separator);
  out.data[65U] =
...
typedef Eurydice_arr_d4 libcrux_iot_ml_dsa_simd_portable_vector_type_Coefficients;

static inline Eurydice_arr_d4 libcrux_iot_ml_dsa_simd_portable_vector_type_zero(void)
{
  Eurydice_arr_d4 lit;
  int32_t repeat_expression[8U];
  for (size_t i = (size_t)0U; i < (size_t)8U; i++)
  {
    repeat_expression[i] = libcrux_secrets_int_public_integers_classify_27_a8((int32_t)0);
  }
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    Eurydice_array_to_slice_shared_a7(libcrux_secrets_int_public_integers_declassify_ref_ad_90(value)),
    int32_t);
}
...
*/
static inline void
libcrux_iot_ml_dsa_simd_portable_add_c5(Eurydice_arr_d4 *lhs, const Eurydice_arr_d4 *rhs)
{
...
*/
static inline void
libcrux_iot_ml_dsa_simd_portable_subtract_c5(Eurydice_arr_d4 *lhs, const Eurydice_arr_d4 *rhs)
{
...
)
{
  ...
  for (size_t i = (size_t)0U; i < (size_t)8U; i++)
  {
    ...
    normalized =
      coefficient -
        (sign & libcrux_secrets_int_public_integers_classify_27_a8((int32_t)2) * coefficient);
    bool uu____0;
    if (result)
    {
      uu____0 = true;
    ...
    case 95232:
      {
        ...
        r1 =
          (result ^
            (libcrux_secrets_int_public_integers_classify_27_a8((int32_t)43) - result) >> 31U)
          & result;
        break;
      }
    case 261888:
...
libcrux_iot_ml_dsa_simd_portable_arithmetic_power2round_element(int32_t t)
{
  ...
  t1 =
    (t2 - (int32_t)1 +
      ((int32_t)1 << (uint32_t)(LIBCRUX_IOT_ML_DSA_CONSTANTS_BITS_IN_LOWER_PART_OF_T - (size_t)1U)))
    >> (uint32_t)LIBCRUX_IOT_ML_DSA_CONSTANTS_BITS_IN_LOWER_PART_OF_T;
  int32_t t0 = t2 - (t1 << (uint32_t)LIBCRUX_IOT_ML_DSA_CONSTANTS_BITS_IN_LOWER_PART_OF_T);
...
*/
static inline void
libcrux_iot_ml_dsa_simd_portable_power2round_c5(Eurydice_arr_d4 *t0, Eurydice_arr_d4 *t1)
{
...
)
{
  ...
  for (size_t i = (size_t)0U; i < randomness.meta; i++)
  {
    ...
    if (libcrux_secrets_int_public_integers_declassify_d8_90(try_0) < 15U)
    {
      ...
      out.ptr[sampled] =
        libcrux_secrets_int_public_integers_classify_27_a8((int32_t)2) - try_0_mod_5;
      sampled++;
    }
    if (libcrux_secrets_int_public_integers_declassify_d8_90(try_1) < 15U)
    {
      ...
      out.ptr[sampled] =
        libcrux_secrets_int_public_integers_classify_27_a8((int32_t)2) - try_1_mod_5;
      sampled++;
    }
  }
  return sampled;
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_SERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 ((int32_t)1 << 17U)
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_SERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1 ((int32_t)1 << 19U)
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 ((int32_t)1 << 17U)

#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK ((LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 << 1U) - (int32_t)1)
...
)
{
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)9U; i++)
  {
    ...
    coefficient0 = coefficient0 | libcrux_secrets_int_as_i32_59(bytes.ptr[1U]) << 8U;
    coefficient0 = coefficient0 | libcrux_secrets_int_as_i32_59(bytes.ptr[2U]) << 16U;
    coefficient0 =
      coefficient0 &
    ...
    coefficient1 = coefficient1 | libcrux_secrets_int_as_i32_59(bytes.ptr[3U]) << 6U;
    coefficient1 = coefficient1 | libcrux_secrets_int_as_i32_59(bytes.ptr[4U]) << 14U;
    coefficient1 =
      coefficient1 &
        LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    int32_t coefficient2 = libcrux_secrets_int_as_i32_59(bytes.ptr[4U]) >> 4U;
    coefficient2 = coefficient2 | libcrux_secrets_int_as_i32_59(bytes.ptr[5U]) << 4U;
    coefficient2 = coefficient2 | libcrux_secrets_int_as_i32_59(bytes.ptr[6U]) << 12U;
    coefficient2 =
      coefficient2 &
        LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    int32_t coefficient3 = libcrux_secrets_int_as_i32_59(bytes.ptr[6U]) >> 6U;
    coefficient3 = coefficient3 | libcrux_secrets_int_as_i32_59(bytes.ptr[7U]) << 2U;
    coefficient3 = coefficient3 | libcrux_secrets_int_as_i32_59(bytes.ptr[8U]) << 10U;
    coefficient3 =
      coefficient3 &
        LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1 ((int32_t)1 << 19U)

#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1_TIMES_2_BITMASK ((LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1 << 1U) - (int32_t)1)
...
)
{
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)5U; i++)
  {
    ...
    coefficient1 = coefficient1 | libcrux_secrets_int_as_i32_59(bytes.ptr[3U]) << 4U;
    coefficient1 = coefficient1 | libcrux_secrets_int_as_i32_59(bytes.ptr[4U]) << 12U;
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_ERROR_SERIALIZE_WHEN_ETA_IS_4_ETA ((int32_t)4)
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_ERROR_SERIALIZE_WHEN_ETA_IS_2_ETA ((int32_t)2)
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_ERROR_DESERIALIZE_WHEN_ETA_IS_4_ETA ((int32_t)4)
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_ERROR_DESERIALIZE_WHEN_ETA_IS_2_ETA ((int32_t)2)
...
)
{
  ...
  serialized.ptr[uu____0] =
    (uint32_t)serialized.ptr[uu____0] | (uint32_t)libcrux_secrets_int_as_u8_36(coefficient1 << 5U);
  ...
  serialized.ptr[uu____1] =
    (uint32_t)serialized.ptr[uu____1] | (uint32_t)libcrux_secrets_int_as_u8_36(coefficient2 << 2U);
  serialized.ptr[4U] = libcrux_secrets_int_as_u8_36(coefficient2 >> 6U);
  size_t uu____2 = (size_t)4U;
  serialized.ptr[uu____2] =
    (uint32_t)serialized.ptr[uu____2] | (uint32_t)libcrux_secrets_int_as_u8_36(coefficient3 << 7U);
  ...
  serialized.ptr[uu____3] =
    (uint32_t)serialized.ptr[uu____3] | (uint32_t)libcrux_secrets_int_as_u8_36(coefficient4 << 4U);
  ...
  serialized.ptr[uu____4] =
    (uint32_t)serialized.ptr[uu____4] | (uint32_t)libcrux_secrets_int_as_u8_36(coefficient5 << 1U);
  serialized.ptr[9U] = libcrux_secrets_int_as_u8_36(coefficient5 >> 7U);
  size_t uu____5 = (size_t)9U;
  serialized.ptr[uu____5] =
    (uint32_t)serialized.ptr[uu____5] | (uint32_t)libcrux_secrets_int_as_u8_36(coefficient6 << 6U);
  ...
  serialized.ptr[uu____6] =
    (uint32_t)serialized.ptr[uu____6] | (uint32_t)libcrux_secrets_int_as_u8_36(coefficient7 << 3U);
...
#define LIBCRUX_IOT_ML_DSA_SIMD_PORTABLE_ENCODING_T0_DESERIALIZE_BITS_IN_LOWER_PART_OF_T_MASK (((int32_t)1 << (uint32_t)(int32_t)LIBCRUX_IOT_ML_DSA_CONSTANTS_BITS_IN_LOWER_PART_OF_T) - (int32_t)1)
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)8U / (size_t)4U; i++)
  {
    ...
    serialized.ptr[(size_t)5U * i0] =
      (uint8_t)(libcrux_secrets_int_public_integers_declassify_d8_a8(coefficients.ptr[0U]) &
        (int32_t)255);
...
)
{
  int32_t
  mask =
    ((int32_t)1 << (uint32_t)LIBCRUX_IOT_ML_DSA_CONSTANTS_BITS_IN_UPPER_PART_OF_T) - (int32_t)1;
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)5U; i++)
  {
    size_t i0 = i;
    Eurydice_borrow_slice_u8
    ...
    simd_unit->data[(size_t)4U * i0] =
      libcrux_secrets_int_public_integers_classify_27_a8((byte0 | byte1 << 8U) & mask);
    simd_unit->data[(size_t)4U * i0 + (size_t)1U] =
      libcrux_secrets_int_public_integers_classify_27_a8((byte1 >> 2U | byte2 << 6U) & mask);
    simd_unit->data[(size_t)4U * i0 + (size_t)2U] =
      libcrux_secrets_int_public_integers_classify_27_a8((byte2 >> 4U | byte3 << 4U) & mask);
    simd_unit->data[(size_t)4U * i0 + (size_t)3U] =
      libcrux_secrets_int_public_integers_classify_27_a8((byte3 >> 6U | byte4 << 2U) & mask);
  }
}
...
- $32size_t
*/
typedef struct Eurydice_arr_79_s { Eurydice_arr_d4 data[32U]; } Eurydice_arr_79;
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_7(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_6(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_5(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_4(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_3(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2(Eurydice_arr_79 *re)
{
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)0U, (int32_t)2706023);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)1U, (int32_t)95776);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)2U, (int32_t)3077325);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)3U, (int32_t)3530437);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)4U, (int32_t)-1661693);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)5U, (int32_t)-3592148);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)6U, (int32_t)-2537516);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)7U, (int32_t)3915439);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)8U, (int32_t)-3861115);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)9U, (int32_t)-3043716);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)10U, (int32_t)3574422);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)11U, (int32_t)-2867647);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)12U, (int32_t)3539968);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)13U, (int32_t)-300467);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)14U, (int32_t)2348700);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)15U, (int32_t)-539299);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)16U, (int32_t)-1699267);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)17U, (int32_t)-1643818);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)18U, (int32_t)3505694);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)19U, (int32_t)-3821735);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)20U, (int32_t)3507263);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)21U, (int32_t)-2140649);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)22U, (int32_t)-1600420);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)23U, (int32_t)3699596);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)24U, (int32_t)811944);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)25U, (int32_t)531354);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)26U, (int32_t)954230);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)27U, (int32_t)3881043);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)28U, (int32_t)3900724);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)29U, (int32_t)-2556880);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)30U, (int32_t)2071892);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(re, (size_t)31U, (int32_t)-2797779);
}
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_1(Eurydice_arr_79 *re)
{
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_1_round(re,
    (size_t)0U,
    (int32_t)-3930395,
    (int32_t)-1528703);
  libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_1_round(re,
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_ntt_ntt_at_layer_0(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void libcrux_iot_ml_dsa_simd_portable_ntt_ntt(Eurydice_arr_79 *re)
{
...
This function found in impl {libcrux_iot_ml_dsa::simd::traits::Operations for libcrux_iot_ml_dsa::simd::portable::vector_type::Coefficients}
*/
static inline void libcrux_iot_ml_dsa_simd_portable_ntt_c5(Eurydice_arr_79 *simd_units)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_0(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_1(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_2(Eurydice_arr_79 *re)
{
  libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_2_round(re,
    (size_t)0U,
    (int32_t)-2797779);
  libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_2_round(re,
    (size_t)1U,
...
libcrux_iot_ml_dsa_simd_portable_vector_type_clone_c2(const Eurydice_arr_d4 *self)
{
  return self[0U];
}
...
libcrux_iot_ml_dsa_simd_portable_invntt_outer_3_plus_99(Eurydice_arr_79 *re)
{
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)1U; i++)
  {
    ...
    Eurydice_arr_d4 a_minus_b = libcrux_iot_ml_dsa_simd_portable_vector_type_clone_c2(&rejs);
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_3(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_4(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_5(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_6(Eurydice_arr_79 *re)
{
...
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_7(Eurydice_arr_79 *re)
{
  libcrux_iot_ml_dsa_simd_portable_invntt_outer_3_plus_993(re);
}

static inline void
libcrux_iot_ml_dsa_simd_portable_invntt_invert_ntt_montgomery(Eurydice_arr_79 *re)
{
...
*/
static inline void
libcrux_iot_ml_dsa_simd_portable_invert_ntt_montgomery_c5(Eurydice_arr_79 *simd_units)
{
...
- $30size_t
*/
typedef struct Eurydice_arr_d2_s { Eurydice_arr_79 data[30U]; } Eurydice_arr_d2;
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_iot_ml_dsa_simd_portable_from_coefficient_array_c5(Eurydice_slice_subslice_shared_46(array,
        (
          KRML_CLITERAL(core_ops_range_Range_08){
...
)
{
  ...
  Eurydice_borrow_slice_u8
  uu____0 =
    Eurydice_array_to_slice_shared_8d(libcrux_secrets_int_public_integers_classify_ref_c5_2c(&seed0));
  Eurydice_borrow_slice_u8
  uu____1 =
    Eurydice_array_to_slice_shared_8d(libcrux_secrets_int_public_integers_classify_ref_c5_2c(&seed1));
  Eurydice_borrow_slice_u8
  uu____2 =
    Eurydice_array_to_slice_shared_8d(libcrux_secrets_int_public_integers_classify_ref_c5_2c(&seed2));
  libcrux_iot_ml_dsa_hash_functions_portable_Shake128X4
  state =
    libcrux_iot_ml_dsa_hash_functions_portable_init_absorb_33(uu____0,
      uu____1,
      uu____2,
      Eurydice_array_to_slice_shared_8d(libcrux_secrets_int_public_integers_classify_ref_c5_2c(&seed3)));
  ...
  Eurydice_borrow_slice_u8
  uu____3 =
    libcrux_secrets_int_classify_public_declassify_ref_7f_90(core_array___Array_T__N___as_slice((size_t)840U,
        rand_stack0,
        uint8_t,
        Eurydice_borrow_slice_u8));
  bool
      ...
      if (done1)
      {
        if (done2)
        {
          ...
          else
          {
            ...
            {
              done0 =
                libcrux_iot_ml_dsa_sample_rejection_sample_less_than_field_modulus_08(Eurydice_array_to_slice_shared_7b(libcrux_secrets_int_public_integers_declassify_ref_ad_fe(&randomnesses.fst)),
                  &sampled0,
                  tmp_stack.ptr);
            }
            if (!done1)
            {
              done1 =
                libcrux_iot_ml_dsa_sample_rejection_sample_less_than_field_modulus_08(Eurydice_array_to_slice_shared_7b(libcrux_secrets_int_public_integers_declassify_ref_ad_fe(&randomnesses.snd)),
                  &sampled1,
                  &tmp_stack.ptr[1U]);
            }
            if (!done2)
            {
              done2 =
                libcrux_iot_ml_dsa_sample_rejection_sample_less_than_field_modulus_08(Eurydice_array_to_slice_shared_7b(libcrux_secrets_int_public_integers_declassify_ref_ad_fe(&randomnesses.thd)),
                  &sampled2,
                  &tmp_stack.ptr[2U]);
            }
            if (!done3)
            {
              done3 =
                libcrux_iot_ml_dsa_sample_rejection_sample_less_than_field_modulus_08(Eurydice_array_to_slice_shared_7b(libcrux_secrets_int_public_integers_declassify_ref_ad_fe(&randomnesses.f3)),
                  &sampled3,
                  &tmp_stack.ptr[3U]);
            }
          }
  ...
  {
    size_t k = i;
    libcrux_iot_ml_dsa_polynomial_from_i32_array_c2_08(Eurydice_array_to_slice_shared_200(libcrux_secrets_int_public_integers_classify_ref_c5_0d(&tmp_stack.ptr[k])),
...
- N= 30
*/
static inline Eurydice_dst_ref_mut_32 Eurydice_array_to_slice_mut_97(Eurydice_arr_d2 *a)
{
...
- $11size_t
*/
typedef struct Eurydice_arr_740_s { Eurydice_arr_79 data[11U]; } Eurydice_arr_740;
...
)
{
  ...
  libcrux_iot_ml_dsa_hash_functions_portable_Shake256X4
  state =
    libcrux_iot_ml_dsa_hash_functions_portable_init_absorb_x4_29(Eurydice_array_to_slice_shared_39(&seed0),
  ...
  {
    size_t i0 = i;
    libcrux_iot_ml_dsa_polynomial_from_i32_array_c2_08(Eurydice_array_to_slice_shared_200(&out.data[i0
        % (size_t)4U]),
      &re.ptr[i0]);
  }
}
...
- N= 11
*/
static inline Eurydice_dst_ref_mut_32 Eurydice_array_to_slice_mut_970(Eurydice_arr_740 *a)
{
  Eurydice_dst_ref_mut_32 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)11U;
...
- $6size_t
*/
typedef struct Eurydice_arr_10_s { Eurydice_arr_79 data[6U]; } Eurydice_arr_10;
...
- $5size_t
*/
typedef struct Eurydice_arr_1d_s { Eurydice_arr_79 data[5U]; } Eurydice_arr_1d;
...
- N= 5
*/
static inline Eurydice_dst_ref_mut_32 Eurydice_array_to_slice_mut_971(Eurydice_arr_1d *a)
{
  Eurydice_dst_ref_mut_32 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)5U;
...
- N= 11
*/
static inline Eurydice_dst_ref_shared_32
Eurydice_array_to_subslice_shared_52(const Eurydice_arr_740 *a, core_ops_range_Range_08 r)
{
  return
    (
      KRML_CLITERAL(Eurydice_dst_ref_shared_32){ .ptr = a->data + r.start, .meta = r.end - r.start }
    );
}
...
*/
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_polynomial_add_c2_08(Eurydice_arr_79 *self, const Eurydice_arr_79 *rhs)
{
  for (size_t i = (size_t)0U; i < (size_t)32U; i++)
  {
    size_t i0 = i;
...
*/
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_ntt_invert_ntt_montgomery_08(Eurydice_arr_79 *re)
{
...
libcrux_iot_ml_dsa_matrix_compute_as1_plus_s2_08(
  size_t rows_in_a,
  size_t columns_in_a,
  Eurydice_dst_ref_shared_32 a_as_ntt,
  Eurydice_dst_ref_shared_32 s1_ntt,
  Eurydice_dst_ref_shared_32 s1_s2,
...
*/
static inline Eurydice_dst_ref_shared_32
Eurydice_array_to_slice_shared_97(const Eurydice_arr_d2 *a)
{
...
*/
static inline Eurydice_dst_ref_shared_32
Eurydice_array_to_slice_shared_970(const Eurydice_arr_1d *a)
{
  Eurydice_dst_ref_shared_32 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)5U;
...
*/
static inline Eurydice_dst_ref_shared_32
Eurydice_array_to_slice_shared_971(const Eurydice_arr_740 *a)
{
  Eurydice_dst_ref_shared_32 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)11U;
...
- N= 6
*/
static inline Eurydice_dst_ref_mut_32 Eurydice_array_to_slice_mut_972(Eurydice_arr_10 *a)
{
  Eurydice_dst_ref_mut_32 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)6U;
...
*/
static inline Eurydice_dst_ref_shared_32
Eurydice_array_to_slice_shared_972(const Eurydice_arr_10 *a)
{
  Eurydice_dst_ref_shared_32 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)6U;
...
{
  libcrux_iot_sha3_portable_shake256(Eurydice_array_to_slice_mut_d8(out), input);
}
...
libcrux_iot_ml_dsa_encoding_signing_key_generate_serialized_1b(
  ...
  Eurydice_dst_ref_shared_32 s1_2,
...
)
{
  ...
  libcrux_iot_ml_dsa_hash_functions_portable_shake256_a1_24(libcrux_secrets_int_classify_public_classify_ref_9b_90(verification_key),
  ...
  Eurydice_slice_copy(Eurydice_slice_subslice_mut_7e(signing_key_serialized,
    ...
    uint8_t);
  offset = offset + LIBCRUX_IOT_ML_DSA_CONSTANTS_BYTES_FOR_VERIFICATION_KEY_HASH;
...
)
{
  ...
  memcpy(a_as_ntt.data, repeat_expression1, (size_t)30U * sizeof (Eurydice_arr_79));
  Eurydice_borrow_slice_u8
  uu____3 = libcrux_secrets_int_classify_public_declassify_ref_7f_90(seed_for_a);
  ...
  Eurydice_slice_copy(Eurydice_array_to_slice_mut_971(&s1_ntt),
    Eurydice_array_to_subslice_shared_52(&s1_s2,
      (
        KRML_CLITERAL(core_ops_range_Range_08){
          .start = (size_t)0U,
  ...
  libcrux_iot_ml_dsa_matrix_compute_as1_plus_s2_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
    ...
    Eurydice_array_to_slice_mut_972(&t0));
  Eurydice_arr_10 t1;
  ...
  libcrux_iot_ml_dsa_arithmetic_power2round_vector_08(Eurydice_array_to_slice_mut_972(&t0),
    Eurydice_array_to_slice_mut_972(&t1));
  Eurydice_borrow_slice_u8
  uu____4 = libcrux_secrets_int_classify_public_declassify_ref_7f_90(seed_for_a);
  libcrux_iot_ml_dsa_encoding_verification_key_generate_serialized_08(uu____4,
    Eurydice_array_to_slice_shared_972(&t1),
    verification_key);
  libcrux_iot_ml_dsa_encoding_signing_key_generate_serialized_1b(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
    ...
    Eurydice_array_to_slice_shared_971(&s1_s2),
    Eurydice_array_to_slice_shared_972(&t0),
    signing_key);
}
...
libcrux_iot_ml_dsa_ml_dsa_65_portable_generate_key_pair(Eurydice_arr_600 randomness)
{
  Eurydice_arr_d10 signing_key;
  ...
  return
    (
      KRML_CLITERAL(libcrux_iot_ml_dsa_types_MLDSAKeyPair_06){
        .signing_key = libcrux_iot_ml_dsa_types_new_f8_09(signing_key),
        .verification_key = libcrux_iot_ml_dsa_types_new_e9_97(verification_key)
      }
    );
}
...
*/
static inline Result_80
libcrux_iot_ml_dsa_pre_hash_new_c9(Eurydice_borrow_slice_u8 context, Option_b5 pre_hash_oid)
{
  if (!(context.meta > LIBCRUX_IOT_ML_DSA_CONSTANTS_CONTEXT_MAX_LEN))
  {
    return
      (
        KRML_CLITERAL(Result_80){
          .tag = Ok,
...
)
{
  ...
  for (size_t i = (size_t)0U; i < randomness.meta; i++)
  {
    ...
    if (!done)
    {
      size_t sample_at = (size_t)libcrux_secrets_int_public_integers_declassify_d8_90(byte[0U]);
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_iot_ml_dsa_simd_portable_t0_deserialize_c5(Eurydice_slice_subslice_shared_7e(serialized,
        (
          KRML_CLITERAL(core_ops_range_Range_08){
            .start = i0 * LIBCRUX_IOT_ML_DSA_ENCODING_T0_OUTPUT_BYTES_PER_SIMD_UNIT,
            .end = (i0 + (size_t)1U) * LIBCRUX_IOT_ML_DSA_ENCODING_T0_OUTPUT_BYTES_PER_SIMD_UNIT
...
)
{
  ...
  shake = libcrux_iot_ml_dsa_hash_functions_portable_init_88();
  libcrux_iot_ml_dsa_hash_functions_portable_absorb_88(&shake,
    libcrux_secrets_int_classify_public_classify_ref_9b_90(verification_key_hash));
  if (domain_separation_context->tag == Some)
  {
    ...
    *domain_separation_context0 = &domain_separation_context->f0;
    ...
    libcrux_iot_ml_dsa_hash_functions_portable_absorb_88(&shake,
      libcrux_secrets_int_classify_public_classify_ref_9b_90(libcrux_iot_ml_dsa_pre_hash_context_c9(domain_separation_context0)));
    const
    Option_b5
    *uu____2 = libcrux_iot_ml_dsa_pre_hash_pre_hash_oid_c9(domain_separation_context0);
    if (uu____2->tag == Some)
    {
      ...
      libcrux_iot_ml_dsa_hash_functions_portable_absorb_88(uu____3,
        Eurydice_array_to_slice_shared_da(libcrux_secrets_int_public_integers_classify_ref_c5_4e(pre_hash_oid)));
    }
  }
...
{
  libcrux_iot_sha3_portable_shake256(Eurydice_array_to_slice_mut_fa(out), input);
}
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_iot_ml_dsa_simd_portable_gamma1_deserialize_c5(Eurydice_slice_subslice_shared_7e(serialized,
        (
          KRML_CLITERAL(core_ops_range_Range_08){
...
libcrux_iot_ml_dsa_hash_functions_portable_shake256_c8(
  Eurydice_borrow_slice_u8 input,
  Eurydice_arr_c31 *out
)
{
  libcrux_iot_sha3_portable_shake256(Eurydice_array_to_slice_mut_7d(out), input);
}
...
libcrux_iot_ml_dsa_hash_functions_portable_shake256_x4_29_c8(
  ...
  Eurydice_borrow_slice_u8 input2,
  Eurydice_borrow_slice_u8 input3,
  Eurydice_arr_c31 *out0,
  Eurydice_arr_c31 *out1,
  Eurydice_arr_c31 *out2,
  Eurydice_arr_c31 *out3
)
{
    ...
    case 17U:
      {
        ...
        libcrux_iot_ml_dsa_hash_functions_portable_shake256_a1_1b(Eurydice_array_to_slice_shared_39(seed),
          &out);
    ...
    case 19U:
      {
        ...
        libcrux_iot_ml_dsa_hash_functions_portable_shake256_a1_c8(Eurydice_array_to_slice_shared_39(seed),
          &out);
        libcrux_iot_ml_dsa_encoding_gamma1_deserialize_08(gamma1_exponent,
          Eurydice_array_to_slice_shared_7d(&out),
          result);
        break;
      }
    default:
...
libcrux_iot_ml_dsa_sample_sample_mask_vector_1a(
  size_t dimension,
  size_t gamma1_exponent,
  const Eurydice_arr_06 *seed,
  uint16_t *domain_separator,
  Eurydice_dst_ref_mut_32 mask
)
{
  Eurydice_arr_a2
  seed0 =
    libcrux_iot_ml_dsa_sample_add_error_domain_separator(Eurydice_array_to_slice_shared_d8(seed),
      domain_separator[0U]);
  Eurydice_arr_a2
  seed1 =
    libcrux_iot_ml_dsa_sample_add_error_domain_separator(Eurydice_array_to_slice_shared_d8(seed),
    ...
    case 17U:
      {
        ...
        libcrux_iot_ml_dsa_hash_functions_portable_shake256_x4_29_1b(Eurydice_array_to_slice_shared_39(&seed0),
          Eurydice_array_to_slice_shared_39(&seed1),
          Eurydice_array_to_slice_shared_39(&seed2),
          Eurydice_array_to_slice_shared_39(&seed3),
          &out0,
    ...
    case 19U:
      {
        ...
        libcrux_iot_ml_dsa_hash_functions_portable_shake256_x4_29_c8(Eurydice_array_to_slice_shared_39(&seed0),
          Eurydice_array_to_slice_shared_39(&seed1),
          Eurydice_array_to_slice_shared_39(&seed2),
          Eurydice_array_to_slice_shared_39(&seed3),
          &out0,
          ...
          &out3);
        libcrux_iot_ml_dsa_encoding_gamma1_deserialize_08(gamma1_exponent,
          Eurydice_array_to_slice_shared_7d(&out0),
          mask.ptr);
        libcrux_iot_ml_dsa_encoding_gamma1_deserialize_08(gamma1_exponent,
          Eurydice_array_to_slice_shared_7d(&out1),
          &mask.ptr[1U]);
        libcrux_iot_ml_dsa_encoding_gamma1_deserialize_08(gamma1_exponent,
          Eurydice_array_to_slice_shared_7d(&out2),
          &mask.ptr[2U]);
        libcrux_iot_ml_dsa_encoding_gamma1_deserialize_08(gamma1_exponent,
          Eurydice_array_to_slice_shared_7d(&out3),
          &mask.ptr[3U]);
        break;
      }
    default:
...
libcrux_iot_ml_dsa_matrix_compute_matrix_x_mask_08(
  size_t rows_in_a,
  size_t columns_in_a,
  Eurydice_dst_ref_shared_32 matrix,
  Eurydice_dst_ref_shared_32 mask,
  Eurydice_dst_ref_mut_32 result
)
{
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++)
...
libcrux_iot_ml_dsa_arithmetic_decompose_vector_08(
  size_t dimension,
  int32_t gamma2,
  Eurydice_dst_ref_shared_32 t,
  Eurydice_dst_ref_mut_32 low,
  Eurydice_dst_ref_mut_32 high
)
{
...
libcrux_iot_ml_dsa_encoding_commitment_serialize_vector_08(
  size_t ring_element_size,
  Eurydice_dst_ref_shared_32 vector,
  Eurydice_mut_borrow_slice_u8 serialized
)
{
  size_t offset = (size_t)0U;
...
)
{
  ...
  uint64_t
  signs =
    core_num__u64__from_le_bytes(unwrap_26_ab((
  ...
  bool
    ...
    libcrux_iot_ml_dsa_sample_inside_out_shuffle(Eurydice_array_to_subslice_from_shared_8c2(&randomness0,
        (size_t)8U),
      &out_index,
      &signs,
      &result);
  while (true)
  {
    ...
    else
    {
      ...
      randomness = libcrux_iot_ml_dsa_hash_functions_portable_squeeze_next_block_a1(&state);
        ...
        libcrux_iot_ml_dsa_sample_inside_out_shuffle(Eurydice_array_to_slice_shared_d4(&randomness),
          &out_index,
          &signs,
          &result);
    }
  }
  libcrux_iot_ml_dsa_polynomial_from_i32_array_c2_08(Eurydice_array_to_slice_shared_20(&result),
    re);
}
...
libcrux_iot_ml_dsa_matrix_vector_times_ring_element_08(
  Eurydice_dst_ref_mut_32 vector,
...
*/
static KRML_MUSTINLINE void
libcrux_iot_ml_dsa_polynomial_subtract_c2_08(Eurydice_arr_79 *self, const Eurydice_arr_79 *rhs)
{
  for (size_t i = (size_t)0U; i < (size_t)32U; i++)
  {
    size_t i0 = i;
...
libcrux_iot_ml_dsa_polynomial_to_i32_array_c2_08(const Eurydice_arr_79 *self)
{
...
libcrux_iot_ml_dsa_arithmetic_make_hint_08(
  Eurydice_dst_ref_shared_32 low,
  Eurydice_dst_ref_shared_32 high,
  int32_t gamma2,
...
)
{
  ...
  for (size_t i0 = (size_t)0U; i0 < low.meta; i0++)
  {
    ...
    Eurydice_arr_c3 uu____0 = libcrux_iot_ml_dsa_polynomial_to_i32_array_c2_08(&hint_simd);
    hint.ptr[i1] = uu____0;
  }
  return true_hints;
}
...
)
{
  ...
  memcpy(s1_as_ntt.data, repeat_expression0, (size_t)5U * sizeof (Eurydice_arr_79));
  ...
  memcpy(s2_as_ntt.data, repeat_expression1, (size_t)6U * sizeof (Eurydice_arr_79));
  ...
  memcpy(t0_as_ntt.data, repeat_expression2, (size_t)6U * sizeof (Eurydice_arr_79));
  libcrux_iot_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
    LIBCRUX_IOT_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
    s1_serialized,
    Eurydice_array_to_slice_mut_971(&s1_as_ntt));
  libcrux_iot_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
    LIBCRUX_IOT_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
    s2_serialized,
    Eurydice_array_to_slice_mut_972(&s2_as_ntt));
  libcrux_iot_ml_dsa_encoding_t0_deserialize_to_vector_then_ntt_08(t0_serialized,
    Eurydice_array_to_slice_mut_972(&t0_as_ntt));
  ...
  memcpy(matrix.data, repeat_expression3, (size_t)30U * sizeof (Eurydice_arr_79));
  Eurydice_borrow_slice_u8
  uu____5 = libcrux_secrets_int_classify_public_declassify_ref_7f_90(seed_for_a);
  libcrux_iot_ml_dsa_samplex4_portable_matrix_flat_ad_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
    uu____5,
  ...
  libcrux_iot_ml_dsa_ml_dsa_generic_derive_message_representative_fd(libcrux_secrets_int_classify_public_declassify_ref_7f_90(verification_key_hash),
  ...
  while (attempt < LIBCRUX_IOT_ML_DSA_CONSTANTS_REJECTION_SAMPLE_BOUND_SIGN)
  {
    ...
    memcpy(commitment.data, repeat_expression8, (size_t)6U * sizeof (Eurydice_arr_79));
    ...
    memcpy(a_x_mask.data, repeat_expression9, (size_t)6U * sizeof (Eurydice_arr_79));
    Eurydice_arr_1d
    mask_ntt =
    ...
    libcrux_iot_ml_dsa_matrix_compute_matrix_x_mask_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      ...
      Eurydice_array_to_slice_mut_972(&a_x_mask));
    libcrux_iot_ml_dsa_arithmetic_decompose_vector_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      ...
      Eurydice_array_to_slice_shared_972(&a_x_mask),
      Eurydice_array_to_slice_mut_972(&w0),
      Eurydice_array_to_slice_mut_972(&commitment));
    ...
    libcrux_iot_ml_dsa_encoding_commitment_serialize_vector_08(LIBCRUX_IOT_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_COMMITMENT_RING_ELEMENT_SIZE,
      Eurydice_array_to_slice_shared_972(&commitment),
    ...
    Eurydice_arr_79 verifier_challenge = libcrux_iot_ml_dsa_polynomial_zero_c2_08();
    libcrux_iot_ml_dsa_sample_sample_challenge_ring_element_1b(Eurydice_array_to_slice_shared_95(&commitment_hash_candidate),
    ...
    challenge_times_s2 =
      core_array__core__clone__Clone_for__Array_T__N___clone((size_t)6U,
        ...
        Eurydice_arr_79,
        Eurydice_arr_10);
    libcrux_iot_ml_dsa_matrix_vector_times_ring_element_08(Eurydice_array_to_slice_mut_971(&challenge_times_s1),
      &verifier_challenge);
    libcrux_iot_ml_dsa_matrix_vector_times_ring_element_08(Eurydice_array_to_slice_mut_972(&challenge_times_s2),
      &verifier_challenge);
    ...
    libcrux_iot_ml_dsa_matrix_subtract_vectors_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      Eurydice_array_to_slice_mut_972(&w0),
      Eurydice_array_to_slice_shared_972(&challenge_times_s2));
    if
    (
      !libcrux_iot_ml_dsa_arithmetic_vector_infinity_norm_exceeds_08(Eurydice_array_to_slice_shared_970(&mask),
        ((int32_t)1 << (uint32_t)LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA1_EXPONENT) -
          LIBCRUX_IOT_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_BETA)
    )
    {
      if
      (
        !libcrux_iot_ml_dsa_arithmetic_vector_infinity_norm_exceeds_08(Eurydice_array_to_slice_shared_972(&w0),
          LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2 -
            LIBCRUX_IOT_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_BETA)
      )
      {
        ...
        challenge_times_t0 =
          core_array__core__clone__Clone_for__Array_T__N___clone((size_t)6U,
            ...
            Eurydice_arr_79,
            Eurydice_arr_10);
        libcrux_iot_ml_dsa_matrix_vector_times_ring_element_08(Eurydice_array_to_slice_mut_972(&challenge_times_t0),
          &verifier_challenge);
        if
        (
          !libcrux_iot_ml_dsa_arithmetic_vector_infinity_norm_exceeds_08(Eurydice_array_to_slice_shared_972(&challenge_times_t0),
            LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2)
        )
        {
          libcrux_iot_ml_dsa_matrix_add_vectors_08(LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
            Eurydice_array_to_slice_mut_972(&w0),
            Eurydice_array_to_slice_shared_972(&challenge_times_t0));
          Eurydice_arr_b5
          hint_candidate =
            {
              .data = {
          ...
          size_t
          ones_in_hint =
            libcrux_iot_ml_dsa_arithmetic_make_hint_08(Eurydice_array_to_slice_shared_972(&w0),
              Eurydice_array_to_slice_shared_972(&commitment),
              LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2,
          ...
          if (!(ones_in_hint > LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_MAX_ONES_IN_HINT))
          {
            ...
            commitment_hash0 =
              (KRML_CLITERAL(Option_a6){ .tag = Some, .f0 = commitment_hash_candidate });
            signer_response0 = (KRML_CLITERAL(Option_c1){ .tag = Some, .f0 = mask });
            hint0 = (KRML_CLITERAL(Option_cb){ .tag = Some, .f0 = hint_candidate });
          }
        }
      }
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if (!(hint0.tag == None))
      {
        ...
        const
        Eurydice_arr_5f
        *uu____7 = libcrux_secrets_int_public_integers_declassify_ref_ad_7d(&commitment_hash1);
        libcrux_iot_ml_dsa_encoding_signature_serialize_08(Eurydice_array_to_slice_shared_95(uu____7),
...
)
{
  ...
  uu____0 =
    libcrux_iot_ml_dsa_pre_hash_new_c9(context,
      (KRML_CLITERAL(Option_b5){ .tag = None }));
  if (!(uu____0.tag == Ok))
  {
    return
      (
...
)
{
  ...
  if (uu____0.tag == Ok)
  {
    uu____1 = (KRML_CLITERAL(Result_74){ .tag = Ok, .val = { .case_Ok = signature } });
  }
  else
  {
...
{
  return
    libcrux_iot_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_c4(Eurydice_array_to_slice_shared_ef(signing_key),
      message,
      context,
      randomness);
}
...
{
  return
    libcrux_iot_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_sign(libcrux_iot_ml_dsa_types_as_ref_f8_09(signing_key),
      message,
      context,
      randomness);
}
...
{
  return
    libcrux_iot_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_mut_c4(Eurydice_array_to_slice_shared_ef(signing_key),
      message,
      context,
      randomness,
      signature);
...
#define LIBCRUX_IOT_ML_DSA_PRE_HASH_SHAKE128_OID ((KRML_CLITERAL(Eurydice_arr_cb){ .data = { 6U, 9U, 96U, 134U, 72U, 1U, 101U, 3U, 4U, 2U, 11U } }))
...
)
{
  if (!(context.meta > LIBCRUX_IOT_ML_DSA_CONSTANTS_CONTEXT_MAX_LEN))
  {
    libcrux_iot_ml_dsa_pre_hash_hash_0b_1a(libcrux_secrets_int_classify_public_classify_ref_9b_90(message),
      pre_hash_buffer);
    Result_80
    uu____0 =
      libcrux_iot_ml_dsa_pre_hash_new_c9(context,
        (KRML_CLITERAL(Option_b5){ .tag = Some, .f0 = libcrux_iot_ml_dsa_pre_hash_oid_0b() }));
    if (!(uu____0.tag == Ok))
    {
      return
        (
...
{
  return
    libcrux_iot_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_pre_hashed_36(Eurydice_array_to_slice_shared_ef(signing_key),
      message,
      context,
      pre_hash_buffer,
      randomness);
...
{
  Eurydice_arr_600 pre_hash_buffer;
  ...
  const Eurydice_arr_d10 *uu____0 = libcrux_iot_ml_dsa_types_as_ref_f8_09(signing_key);
  return
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_iot_ml_dsa_simd_portable_t1_deserialize_c5(Eurydice_slice_subslice_shared_7e(serialized,
        (
          KRML_CLITERAL(core_ops_range_Range_08){
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_iot_ml_dsa_encoding_t1_deserialize_08(Eurydice_slice_subslice_shared_7e(serialized,
        (
          KRML_CLITERAL(core_ops_range_Range_08){
...
)
{
  ...
  for (size_t i = (size_t)0U; i < columns_in_a; i++)
  {
    ...
    Eurydice_borrow_slice_u8
    lvalue =
      libcrux_secrets_int_classify_public_classify_ref_9b_90(Eurydice_slice_subslice_shared_7e(signer_response_serialized,
          (
            KRML_CLITERAL(core_ops_range_Range_08){
  ...
  while (true)
  {
    ...
    {
      size_t current_true_hints_seen = (size_t)hint_serialized.ptr[max_ones_in_hint + i0];
...
)
{
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_48
  lvalue = libcrux_secrets_int_public_integers_classify_27_2c(domain_separated_seed);
  libcrux_iot_sha3_state_KeccakState
  state =
    libcrux_iot_ml_dsa_hash_functions_portable_shake128_init_absorb_b5(Eurydice_array_to_slice_shared_8d(&lvalue));
  libcrux_iot_ml_dsa_hash_functions_portable_shake128_squeeze_first_five_blocks_b5(&state,
    rand_stack);
  size_t sampled = (size_t)0U;
  bool
  done =
    libcrux_iot_ml_dsa_sample_rejection_sample_less_than_field_modulus_08(libcrux_secrets_int_classify_public_declassify_ref_7f_90(core_array___Array_T__N___as_slice((size_t)840U,
          rand_stack,
          uint8_t,
          Eurydice_borrow_slice_u8)),
      &sampled,
  ...
  while (true)
  {
    ...
    else
    {
      ...
      if (!done)
      {
          ...
          libcrux_iot_ml_dsa_sample_rejection_sample_less_than_field_modulus_08(libcrux_secrets_int_classify_public_declassify_ref_7f_90(core_array___Array_T__N___as_slice((size_t)168U,
                rand_block,
                uint8_t,
                Eurydice_borrow_slice_u8)),
            &sampled,
  ...
  Eurydice_dst_ref_shared_fc
  lvalue0 =
    libcrux_secrets_int_classify_public_classify_ref_9b_a8(Eurydice_array_to_subslice_to_shared_c2(tmp_stack,
        (size_t)256U));
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)8U; i++)
  {
    size_t i0 = i;
    simd_unit->data[i0] =
      libcrux_iot_ml_dsa_simd_portable_arithmetic_reduce_element(simd_unit->data[i0] <<
          (uint32_t)(int32_t)13);
  }
}
...
*/
static inline void
libcrux_iot_ml_dsa_simd_portable_shift_left_then_reduce_c5_84(Eurydice_arr_d4 *simd_unit)
{
...
)
{
  for (size_t i = (size_t)0U; i < re_vector.meta; i++)
  {
    ...
    /* original Rust expression is not an lvalue in C */
    Eurydice_arr_c3 lvalue = libcrux_secrets_int_public_integers_classify_27_5c(hint.ptr[i0]);
    libcrux_iot_ml_dsa_polynomial_from_i32_array_c2_08(Eurydice_array_to_slice_shared_20(&lvalue),
      &tmp);
...
)
{
  ...
  if (uu____1.tag == Ok)
  {
    if
    (
      libcrux_iot_ml_dsa_arithmetic_vector_infinity_norm_exceeds_08(Eurydice_array_to_slice_shared_970(&deserialized_signer_response),
        ((int32_t)1 << (uint32_t)LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA1_EXPONENT) -
          LIBCRUX_IOT_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_BETA)
    )
    {
    ...
    else
    {
      ...
      libcrux_iot_ml_dsa_hash_functions_portable_shake256_a1_24(Eurydice_array_to_slice_shared_5b(libcrux_secrets_int_public_integers_classify_ref_c5_3d(verification_key)),
        &verification_key_hash);
      Eurydice_arr_06 message_representative;
      uint8_t repeat_expression5[64U];
      for (size_t i = (size_t)0U; i < (size_t)64U; i++)
      ...
      Eurydice_borrow_slice_u8
      uu____3 =
        Eurydice_array_to_slice_shared_d8(libcrux_secrets_int_public_integers_declassify_ref_ad_49(&verification_key_hash));
      libcrux_iot_ml_dsa_ml_dsa_generic_derive_message_representative_fd(uu____3,
        &domain_separation_context,
        libcrux_secrets_int_classify_public_declassify_ref_7f_90(message),
        &message_representative);
      Eurydice_arr_79 verifier_challenge = libcrux_iot_ml_dsa_polynomial_zero_c2_08();
      libcrux_iot_ml_dsa_sample_sample_challenge_ring_element_1b(Eurydice_array_to_slice_shared_95(libcrux_secrets_int_public_integers_classify_ref_c5_7d(&deserialized_commitment_hash)),
        LIBCRUX_IOT_ML_DSA_CONSTANTS_ML_DSA_65_ONES_IN_VERIFIER_CHALLENGE,
        &verifier_challenge);
      libcrux_iot_ml_dsa_ntt_ntt_08(&verifier_challenge);
      for (size_t i = (size_t)0U; i < (size_t)5U; i++)
      ...
      (
        Eurydice_array_eq((size_t)48U,
          ...
          libcrux_secrets_int_public_integers_declassify_ref_ad_7d(&recomputed_commitment_hash),
          uint8_t)
      )
      {
...
{
  return
    libcrux_iot_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_verify(libcrux_iot_ml_dsa_types_as_ref_e9_97(verification_key),
      message,
      context,
...
)
{
  ...
  memcpy(pre_hash_buffer.data, repeat_expression, (size_t)32U * sizeof (uint8_t));
  const Eurydice_arr_4a *uu____0 = libcrux_iot_ml_dsa_types_as_ref_e9_97(verification_key);
...
typedef Eurydice_arr_96 libcrux_iot_ml_dsa_ml_dsa_generic_ml_dsa_65_MLDSA65Signature;

typedef Eurydice_arr_d10 libcrux_iot_ml_dsa_ml_dsa_generic_ml_dsa_65_MLDSA65SigningKey;

typedef Eurydice_arr_4a libcrux_iot_ml_dsa_ml_dsa_generic_ml_dsa_65_MLDSA65VerificationKey;
