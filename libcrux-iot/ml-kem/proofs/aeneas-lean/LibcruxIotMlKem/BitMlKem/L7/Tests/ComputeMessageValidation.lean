/-
  # L7.4 `compute_message` — Phase 0c / Option-4 numerical validation.

  K=2 and K=3 numerical validation of the L7.4 grand equation
  ...
  Author: orchestrator (Phase 0c, 2026-05-29). Result: GREEN (0 lane mismatches).
-/
